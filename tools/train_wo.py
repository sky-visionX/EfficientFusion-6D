...
opt.nepoch=60
opt.refine_margin=0.0000001 #不开启精炼
# opt.resume_posenet='../trained_models/linemod/pose_model_current.pth'
# opt.dataset_root=r'/home/wuyi/wym/EFN6D/DataSet/Linemod_preprocessed_mini' #正式训练时屏蔽
